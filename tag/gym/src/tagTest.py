...
def get_args():
	...
	parser.add_argument('--experience', 			type = str, default = "TagEnv.mp4")
...
def check_args(args):
	...
	if len(args.experience) == 0:
		sys.exit("ARGUMENT ERROR: EXPERIENCE: Experience cannot be empty string")
